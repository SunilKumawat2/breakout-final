...
const page = () => {
  ...
  console.log("sfghsdgfhsdgfj_123",blogData)
  const { id } = useParams();
  console.log("sjdkfsdfjksdkfhsdkfj",id)
  const searchParams = useSearchParams();
//   const type = searchParams.get("type");
// console.log("jksdhfjksdhfjksdfh",type)
  useEffect(() => {
  ...
  return (
    <>
     <Head>
      <link
        rel="canonical"
        href={`https://breakout.in/blogs/${id}`}
      />
    </Head>
      {blogData?.type == "seo" && <BirthdayBlog blogData={blogData} />}
      {blogData?.type != "seo" && <SigngleBlog blogData={blogData} />}
