...
const page = () => {
  ...
  console.log("escapeRooms_escapeRooms", id)
  ...
  return (
    <>
      ...
      <div className="black-gr-div">
        <PartyExpertCon className="sec-padding-top" data="corporate" />
                      ...
                      {escapeRooms &&
                        escapeRooms.map((room, index) => (
                          <div className="col-lg-4 col-12"
                            ...
                            key={index}>
                            <EscapeRoomCard room={room} hasVirtual={true} virtual_games={true} />
                          </div>
                        ))}
                    </div>
                  </div>
