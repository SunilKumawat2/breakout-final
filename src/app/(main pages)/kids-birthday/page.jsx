...
const page = () => {
    ...
    const hmText = 'Gift your child a birthday they’ll <span>treasure forever</span>.With touching moments, <span>unique experiences</span>, & endless fun,Your little one will feel <span>truly special—and</span> so will you!For <span>they deserve the extraordinary.</span>';
  ...
  return (
    <>
        <BirthdayBanner title="Craziest Party Destination For Your Little Hero!" subTitle="Breakout® Celebrations" img={bdayBanner} />
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-lg-12 text-center'>
                            <h3 className='sec-head'>Want to make your kids birthday <span>special?</span></h3>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className='row mt-5 row-gap-25'>
                        {
                            themes.map((bd, index) => (
                                <div className="col-lg-3 col-12" key={index}>
                                    ...
                                    <div className='location-card-content'>
                                        <h3 dangerouslySetInnerHTML={{ __html: bd.title }}></h3>
                                    </div>
                                    </div>
                                </div>
                            ))
