...
const QuizForm = ({
  ...
  console.log("quiz_form", resource)
  /* ================= CALENDAR LOGIC ================= */
    ...
    onSubmit: async (values) => {
      try {
        ...
        const queryParams = {
          ...
          area: getValidValue(rawAnswers?.location),
          ...
          budget_range: getValidValue(rawAnswers?.budget),

          allow_for_hours_option: getValidValue(rawAnswers?.duration),
        };
